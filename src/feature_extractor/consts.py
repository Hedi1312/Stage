...
features_cols = ['cve_id', 'vendor_name', 'product_name', 'cwe_value', 'description']
features_cols_pc = ['cve_id', 'vendor_name', 'product_name', 'primary_cluster', 'description']
features_cols_sc = ['cve_id', 'vendor_name', 'product_name', 'secondary_cluster', 'description']
